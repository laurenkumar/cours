    ...
    >
      <div className="tarifs">
        ...
        <section className="hero my-auto ml-4 mr-4 md:ml-16 md:mr-16 mt-20 mb-20 mt-16">
          ...
          <div
            className="relative z-20 md:mt-0 mt-20 overflow-hidden lg:pt-[120px] lg:pb-[90px]"
          >
            <h2 className="md:font-normal md:text-4xl mb-8 text-left font-semibold text-3xl m-auto">En attendant le curriculum complet</h2>
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
              <div
                className="border-primary bg-white shadow-pricing relative z-10 mb-4 overflow-hidden rounded border border-opacity-20 py-10 px-8 sm:p-12 lg:py-10 lg:px-6 xl:p-12"
              >
                ...
                >
                  Les cours du cursus responsive design
                </p>
                <div className="mb-7">
                  ...
                  <p className="text-body-color mb-1 text-base leading-loose">
                    Un code promo sur le cursus final
                  </p>
                </div>
                <Link
                  href="#"
          ...
          <div
            className="relative z-20 md:mt-0 mt-10 overflow-hidden pb-12 lg:pt-[20px] lg:pb-[90px]"
          >
            <h2 className="md:font-normal md:text-4xl mb-4 text-left font-semibold text-3xl m-auto">Les prix finaux pour le cursus complet</h2>
              ...
              <div className="-mx-4 flex flex-wrap justify-center">
                <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                  ...
                  >
                    ...
                    <h2 className="text-dark mb-5 text-[42px] font-bold">
                      1500€ / <span className="text-xs">Payable en 4 fois sans frais</span>
                    </h2>
                    <p
                      className="text-body-color mb-8 border-b border-[#F2F2F2] pb-8 text-base"
                    >
                ...
                <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                  ...
                  >
                    ...
                    <h2 className="text-dark mb-5 text-[42px] font-bold">
                      500€  / <span className="text-xs">Payable en 4 fois sans frais</span>
                    </h2>
                    <p
                      className="text-body-color mb-8 border-b border-[#F2F2F2] pb-8 text-base"
                    >
