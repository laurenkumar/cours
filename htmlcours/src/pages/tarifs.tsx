    ...
    >
      <div className="tarifs">
        ...
        <section className="hero my-auto ml-4 mr-4 md:ml-16 md:mr-16 mt-20 mb-20 mt-16">
          ...
          <div
            className="relative z-20 md:mt-0 mt-20 overflow-hidden pb-12 lg:pt-[90px] lg:pb-[90px]"
          >
              ...
              <div className="-mx-4 flex flex-wrap justify-center">
                <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                  ...
                  >
                    ...
                    <Link
                      href="#"
                      className="text-white hover:bg-primary hover:border-primary block w-full rounded border border-[#D4DEFF] bg-transparent p-4 text-center text-base font-semibold transition hover:text-[#f25f4c]"
                    >
                ...
                <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                  ...
                  >
                    ...
                    <h2 className="text-dark mb-5 text-[42px] font-bold">
                      20€  / <span className="text-xs">Par mois</span>
                    </h2>
                    <p
                      className="text-body-color mb-8 border-b border-[#F2F2F2] pb-8 text-base"
                    >
                    ...
                    <Link
                      href="#"
                      className="text-black hover:bg-primary hover:border-primary block w-full rounded border border-[#000] bg-transparent p-4 text-center text-base font-semibold transition hover:text-[#f25f4c]"
                    >
