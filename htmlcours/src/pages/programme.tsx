            ...
            <div>
              ...
              <div className="shadow-md">
                <section aria-labelledby="responsive-design" className="border-b-[2px] border-b-[#F36B59]">
                  ...
                  >
                    <h2 className="text-[#ff8906] hover:text-[#F36B59] font-semibold text-lg">Responsive Design</h2>
                  </button>
                  <div 
                ...
                <section aria-labelledby="javascript" className="mt-5 border-b-[2px] border-b-[#F36B59]">
                  ...
                  >
                    <h2 className="text-[#ff8906] hover:text-[#F36B59] font-semibold text-lg">Javascript</h2>
                  </button>
                  <div 
                ...
                <section aria-labelledby="front-end" className="mt-5 border-b-[2px] border-b-[#F36B59]">
                  ...
                  >
                    <h2 className="text-[#ff8906] hover:text-[#F36B59] font-semibold text-lg">Front End</h2>
                  </button>
                  <div 
                    id="frontEndDetails"
                ...
                <section aria-labelledby="back-end" className="mt-5 border-b-[2px] border-b-[#F36B59]">
                  ...
                  >
                    <h2 className="text-[#ff8906] hover:text-[#F36B59] font-semibold text-lg">Back End</h2>
                  </button>
                  <div 
                    id="backEndDetails"
